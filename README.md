...
1. Информация о системе (название системы, объем диска, занятое пространство, свободное пространство)
2. Текущий статус системы (процессы, тесты, состояние системы и тд на подумать)

Раздел ролевой модели:

1. Права доступа к разделам и действиям.

СМС оповещения о назначенных доставках

Раздел пользователи:

1. СМС оповещения с доступом к админке с паролем

Доступ к админке для водителей

Доступ к админке для клиентов

Выгрузки в excel файлах для таблиц

Статистика по доходам, расходам, заявкам и тд.
